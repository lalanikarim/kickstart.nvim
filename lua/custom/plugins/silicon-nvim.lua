return {
  ...
  config = function()
    require('silicon').setup({
      ...
      font = 'VictorMono Nerd Font=26', -- (string) The font and font size to use for the screenshot.
      ...
      background = '#87f', -- (string) The background color for the screenshot.
      shadow = {
      ...
      watermark = {
        text = ' @lalanikarim', -- (string) The text to use as the watermark, set to nil to disable.
